...
Descarga mi [CV](resources/SamuelCalderonCV.pdf){target="_blank"}.
...
card = function(header, body) {
  return htl.html`<div class = "card">${header}${body}</div>`
}
cardBody = function(inner) {
  return htl.html`<div class = "card-body">${inner}</div>`
}

cardHeader = function(title = "Card title", subtitle = "Card subtitle") {
  return htl.html`
  <div class = "d-flex p-3">
    ...
    <div class = "flex-grow-1">
      ...
      <p class="text-muted">Aug 2020 - Actualidad. Lima</p>
    </div>
  </div>
  `
}
